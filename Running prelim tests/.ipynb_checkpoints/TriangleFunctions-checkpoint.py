...
def drawTriangle(steps, startPoint, points, points_to_draw):
    ...
    for i in range(0, steps):
        ...
        """while(True):
            if((cur_largest == dist1) and (inter1[1] <= points[2][1])):
                cur_largest = largest[next_indx]
            if((cur_largest == dist2) and (inter2[1] <= points[2][1])):
                cur_largest = largest[next_indx]
            if((cur_largest == dist3) and (inter3[1] <= points[2][1])):
                cur_largest = largest[next_indx]
            else:
                break
                
        while(True):
            if((cur_largest == dist1) and (inter1[1] >= points[2][0])):
                cur_largest = largest[next_indx]
            if((cur_largest == dist2) and (inter2[1] >= points[2][0])):
                cur_largest = largest[next_indx]
            if((cur_largest == dist3) and (inter3[1] >= points[2][0])):
                cur_largest = largest[next_indx]
            else:
                break"""
